...
import net.guizhanss.fastmachines.core.recipes.loaders.NetworksStorageUpgradeTableRecipeLoader
...
class FastStorageUpgradeTable(
    ...
    override val craftItemMaterial: Material
        get() = Material.CARTOGRAPHY_TABLE

    override val recipeLoader: RecipeLoader
        get() = NetworksStorageUpgradeTableRecipeLoader(this)
